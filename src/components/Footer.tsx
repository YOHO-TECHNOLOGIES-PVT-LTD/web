...
return ( <footer className="bg-[#fff2eb] pt-12 pb-10"> <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-6">
      ...
      {/* Social Icons */}
      <div className="flex flex-wrap justify-center sm:justify-end items-center gap-4 sm:gap-6 text-[#0b3b3d] text-xl sm:text-2xl">
    ...
    <div className="flex justify-center sm:justify-end mt-4">
      <p className="text-[#0b3b3d] text-xs sm:text-sm tracking-wide text-center sm:text-right">
