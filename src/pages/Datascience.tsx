...
export default function WebAppDevelopmentHero() {
  ...
  // Individual content for each tab
  const tabContent = {
    "Predictive Analytics": {
      title: "Predictive Analytics & Forecasting Experts",
      description: "KIAQ's predictive analytics specialists leverage advanced statistical models and machine learning algorithms to forecast trends, anticipate market changes, and optimize business decisions. We transform historical data into actionable insights for strategic planning."
    },
    "Machine Learning": {
      title: "Machine Learning & AI Development Teams",
      description: "Our machine learning engineers develop custom ML models for classification, regression, and recommendation systems. We implement scalable ML pipelines that automate complex processes and deliver measurable business value across industries."
    },
    "AI Solutions": {
      title: "Enterprise AI Implementation Specialists",
      description: "KIAQ's AI solutions teams design and deploy intelligent systems that transform business operations. We integrate AI capabilities into existing workflows, creating smart applications that enhance decision-making and operational efficiency."
    }
  };
    ...
    <div className="font-['Inter_Variable',_sans-serif]">
      ...
      >
        ...
        <div className="relative z-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 w-full py-10 sm:py-0">
          <div className="max-w-[520px] mt-[12vh] sm:mt-[14vh] text-left">
            {/* Title */}
            <h1
      ...
      {/* Tab Section with dynamic content */}
      <section className="relative w-full bg-white overflow-hidden py-7 sm:py-12 lg:py-14 px-4 sm:px-6 lg:px-12 font-['Inter_Variable',_sans-serif]">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="max-w-[900px] pr-0 sm:pr-10">
            <h2 className="text-[20px] sm:text-[26px] md:text-[32px] font-semibold text-[#011123] leading-tight text-left">
              Comprehensive Data Science & AI Services for Enterprise Excellence
            </h2>

            <p className="text-gray-600 mt-2 max-w-[700px] text-[0.9rem] sm:text-[1rem] leading-[1.55] text-left sm:text-justify">
          ...
          {/* CONTENT + IMAGE - Now using tab-specific content */}
          <div className="mt-5 sm:mt-8 grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6 items-center">
            <div className="md:col-span-5">
              ...
              <p className="text-gray-600 text-[0.9rem] sm:text-base leading-[1.6] mb-3 text-left sm:text-justify">
...
>
                ...
                <div>
                  ...
                  <p className="text-sm text-[#011123b3] leading-[1.4] text-left lg:text-text">{card.desc}</p>
                </div>
                <div
        ...
        <div className="relative max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-6 lg:gap-8">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-gray-600 text-sm sm:text-base md:text-lg leading-relaxed mb-4 sm:mb-6 text-justify sm:text-justify">
             ...
             <h2
  className="text-3xl md:text-4xl font-bold  text-start text-image-mask"
  style={{ 
