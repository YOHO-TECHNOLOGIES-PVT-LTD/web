...
import img1 from "../assets/talent/talent Perks Hero.avif";
...
const TalentSection = () => {
  ...
  const faqItems = [
    {
      q: "Who can I refer?",
      a: "You can refer anyone who is actively looking for job opportunities.",
    },
    {
      q: "How can I refer someone?",
      a: "Just share their details using the referral form on our website.",
    },
    {
      q: "What counts as a successful referral?",
      a: "A referral is successful once the candidate completes the hiring process.",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto relative z-10 px-6">
          ...
          <div className="space-y-6">
            {faqItems.map((item, i) => (
              <div
                key={i}
                className="rounded-2xl border border-[#C6E0DA] bg-white shadow-sm overflow-hidden"
              >
                {/* Question Row */}
                <button
                  onClick={() => toggle(i)}
                ...
                >
                  ...
                  {/* Arrow Icon (rotates when opened) */}
                  <svg
                    width="24"
                    height="24"
                    fill="none"
