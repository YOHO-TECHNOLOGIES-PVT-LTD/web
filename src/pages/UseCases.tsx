      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="p-8 border rounded-lg hover:shadow-lg transition-shadow">
            ...
            <a href="/startup-scaling" className="text-orange-600 font-medium">Learn More →</a>
          </div>
          <div className="p-8 border rounded-lg hover:shadow-lg transition-shadow">
            ...
            <a href="/enterprise-projects" className="text-orange-600 font-medium">Learn More →</a>
          </div>
          <div className="p-8 border rounded-lg hover:shadow-lg transition-shadow">
            ...
            <a href="/digital-transformation" className="text-orange-600 font-medium">Learn More →</a>
          </div>
        </div>
      </div>
    </div>
