      ...
      <section className="relative w-full overflow-hidden pb-24 pt-20" style={{ backgroundColor: UI_CONSTANTS.DARK }}>
        ...
        <div className="relative z-10 flex flex-col items-center text-center text-white px-4">
          ...
          <p className="max-w-2xl text-base leading-relaxed text-gray-200">
            Ready to transform your talent strategy? Reach out to our team and 
            discover how KIAQ can drive your organization's success.
          </p>
        </div>

        {/* Contact Card */}
        <div className="relative z-10 mt-10 flex justify-center px-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl p-8 md:p-10 border border-gray-200">
            {/* Work Email */}
            <div className="mb-6">
              <label
                htmlFor="email"
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-md px-4 py-2 text-sm focus:ring-2 focus:border-transparent outline-none transition-all"
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                className="w-full border border-gray-300 rounded-md px-4 py-2 text-sm resize-none focus:ring-2 focus:border-transparent outline-none transition-all"
              ></textarea>
            </div>
              ...
              <div className="flex items-center gap-6 text-sm text-gray-700">
                <label className="flex items-center gap-2">
                  <input
                    ...
                    style={{ 
                      accentColor: UI_CONSTANTS.PRIMARY
                    }}
                  />
                  PARTNERSHIP
                </label>
            ...
            <button
              type="submit"
              className="font-semibold text-sm px-8 py-2.5 rounded-md hover:opacity-90 transition-all duration-300"
              style={{
